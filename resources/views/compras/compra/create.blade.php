...
<div class="row">
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
		<div class="form-group">
			...
			<select name="idproveedor" id="idproveedor" class="form-control selectpicker" data-live-search="true" title="Elija un Proveedor..." data-size="7">
			...
			<div class="col-log-12 col-md-12 col-sm-12 col-xs-12">
				<table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
					...
					<tfoot>
						...
						<th></th>
						<th></th>
						<th><h4 id="total">$</h4><input type="hidden" name="totalcompra" id="totalcompra"</th>
					</tfoot>
					<tbody>
