...
{!!Form::Open(array('url'=>'resultado_ventas','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
<div class="row">
	...
	<div class="col-lg-5 col-md-4 col-sm-4 col-xs-12">
		<div class="form-group">
			...
			<select name="idcliente" id="idcliente" class="form-control selectpicker" data-live-search="true" title="Elija un Cliente..." data-size="5" required>
	...
	<div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
		<div class="form-group">
			...
			<select name="estado" id="estado" class="form-control selectpicker" data-live-search="true" title="Elija Estado..." required>
